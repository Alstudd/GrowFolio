  ...
  return (
    <div className="relative sm:pr-0 pr-8">
      ...
      <div className="flex flex-col gap-6 sm:ml-24 ml-0 2xl:w-[80rem] xl:w-[72.5rem] lg:w-[50rem] md:w-[41rem] sm:w-[28rem] w-full sm:pr-0 pr-8">
        ...
        <p className="ml-10 text-xl font-medium text-[#616161] sm:w-full w-[20rem]"><span className="text-[#00b386]">GrowFolio</span> offers live online consultations with financial experts, ensuring people can seek financial guidance conveniently.</p>
