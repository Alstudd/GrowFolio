      ...
      <div className="py-4 pl-4 self-stretch flex flex-col items-start flex-[1_0_0] lg:pl-32">
        <div className="py-4 flex flex-col items-start gap-4 lg:py-0 pl-4">
          ...
          <motion.h1
            ...
            <span className='text-[#00b386]'>GrowFolio -</span> Empowering Finance Wellness Worldwide
          </motion.h1>
          <motion.p
            initial={{ y: "2rem", opacity: 0 }}
            animate={{ y: "0", opacity: 1 }}
            ...
            className="text-slate-600 font-normal"><i><span className="text-[#00b386]">GrowFolio</span></i> is more than just an app, it's a comprehensive solution created to empower individuals by tackling the financial problems they encounter every day</motion.p>
        </div>
        <motion.div 
        initial={{ x: "-7rem", opacity: 0 }}
        animate={{ x: "0", opacity: 1 }}
